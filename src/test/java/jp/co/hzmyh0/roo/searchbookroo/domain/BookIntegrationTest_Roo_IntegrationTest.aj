...
import jp.co.hzmyh0.roo.searchbookroo.domain.BookDataOnDemand;
...
privileged aspect BookIntegrationTest_Roo_IntegrationTest {
    ...
    public void BookIntegrationTest.testCountBooks() {
        ...
        long count = jp.co.hzmyh0.roo.searchbookroo.domain.Book.countBooks();
    ...
    public void BookIntegrationTest.testFindBook() {
        jp.co.hzmyh0.roo.searchbookroo.domain.Book obj = dod.getRandomBook();
        ...
        obj = jp.co.hzmyh0.roo.searchbookroo.domain.Book.findBook(id);
    ...
    public void BookIntegrationTest.testFindAllBooks() {
        ...
        java.util.List<jp.co.hzmyh0.roo.searchbookroo.domain.Book> result = jp.co.hzmyh0.roo.searchbookroo.domain.Book.findAllBooks();
    ...
    public void BookIntegrationTest.testFindBookEntries() {
        ...
        java.util.List<jp.co.hzmyh0.roo.searchbookroo.domain.Book> result = jp.co.hzmyh0.roo.searchbookroo.domain.Book.findBookEntries(0, (int) count);
    ...
    public void BookIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyBook(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        jp.co.hzmyh0.roo.searchbookroo.domain.Book merged =  obj.merge();
        obj.flush();
    ...
    public void BookIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Book' failed to initialize correctly", dod.getRandomBook());
        jp.co.hzmyh0.roo.searchbookroo.domain.Book obj = dod.getNewTransientBook(Integer.MAX_VALUE);
    ...
    public void BookIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Book' with identifier '" + id + "'", jp.co.hzmyh0.roo.searchbookroo.domain.Book.findBook(id));
    }
